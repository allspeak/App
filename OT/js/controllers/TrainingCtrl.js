...
function TrainingCtrl($scope, $state, $ionicPopup, $ionicHistory, $ionicPlatform, VocabularySrv, InitAppSrv, FileSystemSrv, StringSrv, EnumsSrv)  
{
    ...
    $scope.relpath                                  = "";   // will be AllSpeak/training_sessions
    // =======================================================================================================
    ...
    $scope.$on("$ionicView.enter", function(event, data)
    {
        ...
        $scope.default_training_folder                  = InitAppSrv.getDefaultVocabularyName();
        ...
        .then(function(vocobj)
        {
            ...
            $scope.relpath              = InitAppSrv.getAudioFolder();               // AllSpeak/training_sessions
...
//            $scope.relpath              = $scope.vocabularyObject.rel_local_path;        // AllSpeak/training_sessions/default
        ...
        {
            alert("Error in TrainingCtrl::$ionicView.enter " + error.toString());
        });
    });
