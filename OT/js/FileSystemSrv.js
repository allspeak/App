...
function FileSystemSrv($cordovaFile, $ionicPopup)
{
    ...
    {
        service.data_storage_root    = file_system_app_data.data_storage_root;
    ...
    service.createDir = function(relative_path, force)
    {
        ...
        if (!force)
        {
            return $cordovaFile.checkDir(cordova.file[service.data_storage_root], relative_path)
                    .then(function (success) {return 1;}
                         ,function (error)   {
                            $cordovaFile.createDir(cordova.file[service.data_storage_root], relative_path, true).then(
                                    function (success) {
                                        if (success) {
                                            console.log("created directory", cordova.file[service.data_storage_root]+ relative_path);
                                            return 1;
                                        }
                                    },
                                    function (error) {
    ...
    {
        return cordova.file[service.data_storage_root];
    }
    
    service.saveFile = function(relative_path, content, overwrite)
    {
        return $cordovaFile.writeFile(cordova.file[service.data_storage_root], relative_path, content, overwrite)
        .then(function(){
                return 1;
            },
            function(err){
...
//            return $cordovaFile.checkFile(cordova.file[service.data_storage_root], relative_path)
//                    .then(
//                        function() {
//                            if(!overwrite)
//                            {
...
//                                .then(function(res){
//                                    if(res)
//                                       return $cordovaFile.createFile(cordova.file[service.data_storage_root], relative_path);
//                                    else
//                                       return 0;
//                                })
//                            }
//                            else    return $cordovaFile.createFile(cordova.file[service.data_storage_root], relative_path);
//                        },
//                        function(error){
//                            return $cordovaFile.createFile(cordova.file[service.data_storage_root], relative_path);
//                        }
...
//                            if (do_write)
//                            {
//                                return $cordovaFile.writeFile(cordova.file[service.data_storage_root], relative_path, content, true)
//                                .then(function(){
//                                        return 1;
//                                    },
//                                    function(err){
