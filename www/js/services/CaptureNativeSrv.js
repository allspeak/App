...
function CaptureNativeSrv($cordovaNativeAudio, $cordovaMediaCapture)
{
    this.controller_scope       = {};
    this.window                 = {};   
    
    
    this.audio_modes = $cordovaMediaCapture.supportedAudioModes;
...
//        this.controller_scope.vad_status = "OFF";
 ...
 main_module.service('CaptureNativeSrv', CaptureNativeSrv);