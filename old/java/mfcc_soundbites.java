...
//  private double[] inputData;
   ...
   */
  public mfcc_soundbites(float sampleRate) throws IllegalArgumentException
  {
   ...
   * @throws IllegalArgumentException raised if method contract is violated
   */
  public mfcc_soundbites(float sampleRate, int windowSize, int numberCoefficients, boolean useFirstCoefficient) throws IllegalArgumentException
  {
   ...
   * @throws IllegalArgumentException raised if method contract is violated
   */
  public mfcc_soundbites(float sampleRate, int windowSize, int numberCoefficients, boolean useFirstCoefficient, double minFreq, double maxFreq, int numberFilters) throws IllegalArgumentException
  {
